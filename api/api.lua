...
local json = (loadfile "/home/ss/data/JSON.lua")()
local token = '310876663:AAE2Iik5SWAIMtZUK9D5-Ho204tyDNWgUZ8' --token
local url = 'https://api.telegram.org/bot' .. token
local offset = 0
local redis = require('redis')
local redis = redis.connect('127.0.0.1', 6379)
local SUDO = 118208388
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 331041673 or q.from.id == 118208388 then
    ...
    return false
              ...
              local keyboard = {}
							keyboard.inline_keyboard = {
								{
                 {text = '⚜تنظیمات گروه⚜', callback_data = 'groupsettings:'..chat} --,{text = '💴واحدفروش💴', callback_data = 'aboute:'..chat}
                },{
				 {text = '⚜پشتیبانی⚜', callback_data = 'supportbot:'..chat},{text = '⚜تبلیغات⚜', callback_data = 'youradds:'..chat}
				  },{
				 {text = '⚜اطلاعات⚜', callback_data = 'groupinfo:'..chat},{text = '⚜راهنما⚜', callback_data = 'helpbot:'..chat}
				}
							}
          ...
          if msg.callback_query then
            local q = msg.callback_query
             ...
             if q.data:match('_') and not (q.data:match('next_page') or q.data:match('left_page')) then
                Canswer(q.id,">برای مشاهده راهنمای بیشتر این بخش عبارت\n/help\nرا ارسال کنید\n>تیم پشتیبانی:[https://t.me/CLi_APi]\n>کانال پشتیبانی:[https://t.me/CLi_APi]\n>کانال فروش:[https://t.me/CLi_APi]",true)
 ...
 if redis:get(hash) then
    ...
    return false
              ...
              local keyboard = {}
							keyboard.inline_keyboard = {
								{
                 {text = '⚙️تنظیمات گروه⚙️', callback_data = 'groupsettings:'..chat} --,{text = '💴واحدفروش💴', callback_data = 'aboute:'..chat}
                },{
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                  {text = '🔧تیم فنی🔧', callback_data = 'teamfani:'..chat},{text = '💴واحدفروش💴', callback_data = 'fahedsale:'..chat}
                },{
				 {text = '👁‍🗨گزارش مشکل👁', callback_data = 'reportproblem:'..chat},{text = '✍🏽انتقادات و پیشنهادات✍', callback_data = 'enteqadvapishnehad:'..chat}
				 },{
				 {text = '⁉️سوالات متداول⁉', callback_data = 'soalatmotadavel:'..chat}
                },{
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'>[راهنمای مالکین گروه(اصلی-فرعی)](https://t.me/NinjaHacker)\n*[/#!]options* --دریافت تنظیمات گروه به صورت اینلاین\n*[/#!]setrules text* --تنظیم قوانین گروه\n*[/#!]modset* @username|reply|user-id -- انتخاب ادمین\n*[/#!]moddem* @username|reply|user-id --حذف ادمین\n*[/#!]ownerlist* --مالکین\n*[/#!]managers* --ادمینها\n*[/#!]setlink link* {لینک-گروه} --تنظیم لینک\n*[/#!]link* لینک\n*[/#!]kick* @username|reply|user-id اخراج کاربر با ریپلی|یوزرنیم|شناسه\n*_______________________*\n>[راهنمای بخش حذف ها](https://t.me/NinjaHacker)\n*[/#!]delete managers* {حذف ادمینها}\n*[/#!]delete welcome* {حذف ولکام}\n*[/#!]delete bots* {حذف رباتها}\n*[/#!]delete silentlist* {حذف لیست سکوت}\n*[/#!]delete filterlist* {ریست فیلتر}\n*_______________________*\n>[راهنمای بخش خوش آمدگویی](https://t.me/NinjaHacker)\n*[/#!]welcome enable* --(ولکام فعال)\n*[/#!]welcome disable* --(ولکام غیرفعال)\n*[/#!]setwelcome text* --(تنظیم ولکام)\n*_______________________*\n>[راهنمای بخش فیلترگروه](https://t.me/NinjaHacker)\n*[/#!]mutechat* -- سکوت\n*[/#!]unmutechat* --لغوسکوت\n*[/#!]mutechat number(h|m|s)* --سکوت بر حسب زمان[ساعت|دقیقه|ثانیه]\n*_______________________*\n>[راهنمای دستورات حالت سکوت کاربران](https://t.me/NinjaHacker)\n*[/#!]silentuser* @username|reply|user-id --تحریم\n*[/#!]unsilentuser* @username|reply|user-id --رفع تحریم\n*[/#!]silentlist* --لیست تحریم\n*_______________________*\n>[راهنمای بخش فیلتر-کلمات](https://t.me/NinjaHacker)\n*[/#!]filter word --فیلتر(کلمه)\n[/#!]unfilter word* --حذف فیلتر(کلمه)\n*[/#!]filterlist* --لیست فیلتر\n*_______________________*\n>[راهنمای بخش تنظیم پیغام مکرر](https://t.me/NinjaHacker)\n*[/#!]floodmax number* --تنظیم حساسیت نسبت به ارسال پیام مکرر\n*[/#!]floodtime* --تنظیم حساسیت نسبت به ارسال پیام مکرر برحسب زمان',keyboard)
            end
							------------------------------------------------------------------------
          ...
          return '🔓'
              ...
              local keyboard = {}
            	keyboard.inline_keyboard = {
                 ...
                 {text=getsettings('username'),callback_data=chat..':lock username'}, {text = '🌀ایدی🌀', callback_data = chat..'_username'}
                },{
                  {text=getsettings('contact'),callback_data=chat..':lock contact'},{text = '☎️مخاطبین☎', callback_data = chat..'_contact'}
                },{
        ...
        elseif is_lock(chat,value) then
          ...
          return '🔓'
         		...
         		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                  {text=getsettings('forward'),callback_data=chat..':lock forward'},{text = '⏮فروارد⏮', callback_data = chat..'_forward'}
                },{
                  ...
                  {text=getsettings('persian'),callback_data=chat..':lock persian'},{text = '🇮🇷فارسی🇮🇷', callback_data = chat..'_persian'}
                },{
                  {text=getsettings('english'),callback_data=chat..':lock english'},{text = '🇬🇧انگلیسی🇬🇧', callback_data = chat..'_english'}
                },{
                  {text=getsettings('keyboard'),callback_data=chat..':lock keyboard'},{text = '◻️شیشه ای◻️', callback_data = chat..'_keyboard'}
                },{
                  {text=getsettings('tgservice'),callback_data=chat..':lock tgservice'},{text = '🚷ورودوخروج🚷', callback_data = chat..'_tgservice'}
                },{
                 {text=getsettings('muteall'),callback_data=chat..':lock muteall'}, {text = '🤐 سکوت 🤐', callback_data = chat..'_muteall'}
                },{
